...
contract LexEngineer {
    ...
    function _mint(address to, string calldata _tokenURI) private { 
        totalSupply++;
    ...
    function govTransferFrom(address from, address to, uint256 tokenId) external onlyLexDAO {
